...
def exibir_lancamentos():
    ...
    if st.session_state.get('tipo_usuario_atual') == 'Administrador':
        ...
        # Removida variável não utilizada após remoção do PDF
    ...
    if not lancamentos_para_exibir:
        ...
        # Alterada a criação de colunas para ter apenas 1 para o Excel
        col_excel = st.columns([1])[0] # Apenas uma coluna para o botão Excel
        with col_excel:
        ...
        # Removidos botões de download de PDF
        # with col_pdf_lista:
